...
} from "./chunk-I3MTB3CE.js";
import {
  require_dist
} from "./chunk-QUJUCAA4.js";
import {
  __toESM
...
var require_vanilla = __commonJS({
  "../../node_modules/zustand/vanilla.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    function create22(createState) {
      var state;
...
var useWrapperContext = () => {
  const val3 = (0, import_react3.useContext)(ctx);
  if (!val3) {
...
var createEditable = (config2) => {
  const editable2 = (Component, type) => {
    ...
    return (0, import_react2.forwardRef)((_a, ref) => {
      ...
      const sheet2 = useCurrentSheet();
      const [sheetObject2, setSheetObject] = (0, import_react.useState)(void 0);
      const storeKey = (0, import_react.useMemo)(() => makeStoreKey(__spreadProps(__spreadValues({}, sheet2.address), {
...
`);
      ...
      (0, import_react2.useLayoutEffect)(() => {
        if (!sheet2)
          return;
        if (sheetObject2) {
          sheet2.object(theatreKey, Object.assign(__spreadValues({}, additionalProps), ...Object.values(config2[actualType].props).map((value) => value.type)), { reconfigure: true });
          return;
        } else {
          const sheetObject22 = sheet2.object(theatreKey, Object.assign(__spreadValues({}, additionalProps), ...Object.values(config2[actualType].props).map((value) => value.type)));
          allRegisteredObjects.add(sheetObject22);
          setSheetObject(sheetObject22);
          if (objRef)
            typeof objRef === "function" ? objRef(sheetObject22) : objRef.current = sheetObject22;
          editorStore.getState().addEditable(storeKey, {
            type: actualType,
            sheetObject: sheetObject22,
            visibleOnlyInEditor: visible === "editor",
            objectConfig: config2[actualType]
          });
        }
      }, [sheet2, storeKey, additionalProps]);
      (0, import_react2.useLayoutEffect)(() => {
        if (!sheetObject2)
          return;
        sheetObject2.initialValue = Object.fromEntries(Object.entries(config2[actualType].props).map(([key, value]) => [key, value.parse(props)]));
      }, [
        sheetObject2,
      ...
      (0, import_react2.useLayoutEffect)(() => {
        ...
        return () => {
          untap();
          sheetObject2.sheet.detachObject(theatreKey);
          allRegisteredObjects.delete(sheetObject2);
...
var PerspectiveCamera2 = editable_default((0, import_react5.forwardRef)((_a, ref) => {
...
var OrthographicCamera2 = editable_default((0, import_react6.forwardRef)((_a, ref) => {
  var _b = _a, { makeDefault, lookAt } = _b, props = __objRest(_b, ["makeDefault", "lookAt"]);
  const set = useThree(({ set: set2 }) => set2);
  const camera = useThree(({ camera: camera2 }) => camera2);
  const size = useThree(({ size: size2 }) => size2);
...
var import_dataverse3 = __toESM(require_dist());
...
var require_zustand = __commonJS2({
...
var require_shallow = __commonJS2({
...
var require_scheduler_production_min = __commonJS2({
  "../../node_modules/scheduler/cjs/scheduler.production.min.js"(exports2) {
    ...
    exports2.unstable_scheduleCallback = function(a2, b2, c2) {
      ...
      c2 > d2 ? (a2.sortIndex = c2, H2(M2, a2), J2(L2) === null && a2 === J2(M2) && (S2 ? h2() : S2 = true, g2(U2, c2 - d2))) : (a2.sortIndex = e2, H2(L2, a2), R2 || Q2 || (R2 = true, f(V2)));
      return a2;
    };
...
var require_scheduler = __commonJS2({
...
var require_react_reconciler_production_min = __commonJS2({
  "../../node_modules/react-reconciler/cjs/react-reconciler.production.min.js"(exports2, module2) {
    module2.exports = function $$$reconciler($$$hostConfig) {
      var exports3 = {};
      "use strict";
      var aa = require_object_assign(), ba = require_react2(), m2 = require_scheduler();
      function q2(a2) {
        for (var b2 = "https://reactjs.org/docs/error-decoder.html?invariant=" + a2, c2 = 1; c2 < arguments.length; c2++)
          b2 += "&args[]=" + encodeURIComponent(arguments[c2]);
        return "Minified React error #" + a2 + "; visit " + b2 + " for the full message or use the non-minified dev environment for full errors and additional helpful warnings.";
      ...
      function Ze2(a2, b2, c2, d2, e2) {
        ...
        if (b2.stateNode === null)
          ...
          od(b2, d2, g2, e2);
          k2 = b2.memoizedState;
          h2 !== d2 || p !== k2 || D2.current || hd ? (typeof n2 === "function" && (sd(b2, c2, n2, d2), k2 = b2.memoizedState), (h2 = hd || wd(b2, c2, h2, d2, p, k2, l2)) ? (t2 || typeof g2.UNSAFE_componentWillMount !== "function" && typeof g2.componentWillMount !== "function" || (typeof g2.componentWillMount === "function" && g2.componentWillMount(), typeof g2.UNSAFE_componentWillMount === "function" && g2.UNSAFE_componentWillMount()), typeof g2.componentDidMount === "function" && (b2.flags |= 4)) : (typeof g2.componentDidMount === "function" && (b2.flags |= 4), b2.memoizedProps = d2, b2.memoizedState = k2), g2.props = d2, g2.state = k2, g2.context = l2, d2 = h2) : (typeof g2.componentDidMount === "function" && (b2.flags |= 4), d2 = false);
        } else {
          g2 = b2.stateNode;
          jd(a2, b2);
          h2 = b2.memoizedProps;
      ...
      function Ef(a2, b2, c2) {
        ...
        f !== null && typeof f.componentDidCatch === "function" && (c2.callback = function() {
          typeof d2 !== "function" && (Ff === null ? Ff = /* @__PURE__ */ new Set([this]) : Ff.add(this), zf(a2, b2));
          var c3 = b2.stack;
      ...
      function ud(a2, b2, c2) {
        ...
        var d2 = Nc();
        b2 === 1 ? (V2 & 8) !== 0 && (V2 & 48) === 0 ? Og(a2) : (Z2(a2, c2), V2 === 0 && (zg(), H2())) : ((V2 & 4) === 0 || d2 !== 98 && d2 !== 99 || (Fg === null ? Fg = /* @__PURE__ */ new Set([a2]) : Fg.add(a2)), Z2(a2, c2));
        yg = a2;
      }
      function Ng(a2, b2) {
        a2.lanes |= b2;
              ...
              if (k2 !== null && typeof k2 === "object" && typeof k2.then === "function") {
                ...
                do {
                  ...
                  if (y2) {
                    ...
                    h2 = b2;
                    var Oa = f.pingCache;
                    Oa === null ? (Oa = f.pingCache = new Af(), k2 = /* @__PURE__ */ new Set(), Oa.set(l2, k2)) : (k2 = Oa.get(l2), k2 === void 0 && (k2 = /* @__PURE__ */ new Set(), Oa.set(l2, k2)));
                    if (!k2.has(h2)) {
                      k2.add(h2);
...
var require_react_reconciler = __commonJS2({
...
var require_react_dom_server_browser_production_min = __commonJS2({
  "../../node_modules/react-dom/cjs/react-dom-server.browser.production.min.js"(exports2) {
    "use strict";
    var l2 = require_object_assign();
    var m2 = require_react2();
    function p(a2) {
      for (var b2 = "https://reactjs.org/docs/error-decoder.html?invariant=" + a2, c2 = 1; c2 < arguments.length; c2++)
        b2 += "&args[]=" + encodeURIComponent(arguments[c2]);
      return "Minified React error #" + a2 + "; visit " + b2 + " for the full message or use the non-minified dev environment for full errors and additional helpful warnings.";
    ...
    function Ca() {
      R2 === null ? Q2 === null ? (S2 = false, Q2 = R2 = Ba()) : (S2 = true, R2 = Q2) : R2.next === null ? (S2 = false, R2 = R2.next = Ba()) : (S2 = true, R2 = R2.next);
      return R2;
    }
    function Da(a2, b2, c2, d2) {
      for (; T2; )
        T2 = false, V2 += 1, R2 = null, c2 = a2(b2, d2);
      Ea();
      return c2;
    }
    function Ea() {
    ...
    function Ga(a2, b2, c2) {
      ...
      if (S2) {
        ...
        return [R2.memoizedState, b2];
      }
      a2 = a2 === Fa ? typeof b2 === "function" ? b2() : b2 : c2 !== void 0 ? c2(b2) : b2;
      R2.memoizedState = a2;
      a2 = R2.queue = { last: null, dispatch: null };
      a2 = a2.dispatch = Ha.bind(null, P2, a2);
      return [R2.memoizedState, a2];
    }
    function Ia(a2, b2) {
      P2 = W2();
      R2 = Ca();
    ...
    function Ha(a2, b2, c2) {
      if (!(25 > V2))
        throw Error(p(301));
      if (a2 === P2)
        if (T2 = true, a2 = { action: c2, next: null }, U2 === null && (U2 = /* @__PURE__ */ new Map()), c2 = U2.get(b2), c2 === void 0)
          U2.set(b2, a2);
        else {
    ...
    var Ka = { readContext: function(a2) {
      ...
      P2 = W2();
      R2 = Ca();
      var b2 = R2.memoizedState;
      return b2 === null ? (a2 = { current: a2 }, R2.memoizedState = a2) : b2;
...
var require_emotion_memoize_cjs_prod = __commonJS2({
...
var require_emotion_memoize_cjs = __commonJS2({
...
var require_emotion_is_prop_valid_cjs_prod = __commonJS2({
  "../../node_modules/@emotion/is-prop-valid/dist/emotion-is-prop-valid.cjs.prod.js"(exports2) {
    ...
    var isPropValid = memoize__default["default"](function(prop) {
      return reactPropsRegex.test(prop) || prop.charCodeAt(0) === 111 && prop.charCodeAt(1) === 110 && prop.charCodeAt(2) < 91;
    });
    exports2.default = isPropValid;
  }
});
var require_emotion_is_prop_valid_cjs = __commonJS2({
...
var require_react_is_production_min2 = __commonJS2({
...
function ye(e2) {
  var t2 = (0, import_react22.useState)(e2.stylisPlugins), n2 = t2[0], s2 = t2[1], c2 = fe(), u2 = (0, import_react22.useMemo)(function() {
    var t3 = c2;
    return e2.sheet ? t3 = e2.sheet : e2.target && (t3 = t3.reconstructWithOptions({ target: e2.target }, false)), e2.disableCSSOMInjection && (t3 = t3.reconstructWithOptions({ useCSSOMInjection: false })), t3;
  }, [e2.disableCSSOMInjection, e2.sheet, e2.target]), l2 = (0, import_react22.useMemo)(function() {
  ...
  }, [e2.stylisPlugins]), import_react22.default.createElement(ue.Provider, { value: u2 }, import_react22.default.createElement(de.Provider, { value: l2 }, false ? import_react22.default.Children.only(e2.children) : e2.children));
}
function be(e2) {
...
function Fe(e2) {
  var t2 = (0, import_react22.useContext)(Ge), n2 = (0, import_react22.useMemo)(function() {
  ...
  return e2.children ? import_react22.default.createElement(Ge.Provider, { value: n2 }, e2.children) : null;
}
function qe(e2, t2, n2) {
  ...
  var C2, I2 = new se(n2, g2, o2 ? e2.componentStyle : void 0), P2 = I2.isStatic && c2.length === 0, O2 = function(e3, t3) {
    return function(e4, t4, n3, r2) {
      ...
      }(Re(t4, (0, import_react22.useContext)(Ge), a3) || E, t4, o3), y2 = f2[0], g3 = f2[1], S3 = function(e5, t5, n4, r3) {
  ...
  return O2.displayName = f, (C2 = import_react22.default.forwardRef(O2)).attrs = S2, C2.componentStyle = I2, C2.displayName = f, C2.shouldForwardProp = A2, C2.foldedComponentIds = o2 ? Array.prototype.concat(e2.foldedComponentIds, e2.styledComponentId) : w, C2.styledComponentId = g2, C2.target = o2 ? e2.target : e2, C2.withComponent = function(e3) {
...
function We(e2) {
  ...
  function l2(e3) {
    var t3 = fe(), n3 = me(), o3 = (0, import_react22.useContext)(Ge), l3 = (0, import_react22.useRef)(t3.allocateGSInstance(a2)).current;
    return false, false, t3.server && h2(l3, e3, t3, o3, n3), (0, import_react22.useLayoutEffect)(function() {
      if (!t3.server)
  ...
  return false, import_react22.default.memo(l2);
}
function Ue(e2) {
  false;
  for (var t2 = arguments.length, n2 = new Array(t2 > 1 ? t2 - 1 : 0), r2 = 1; r2 < t2; r2++)
...
var init_styled_components_browser_esm = __esm({
  "../../node_modules/styled-components/dist/styled-components.browser.esm.js"() {
    import_react_is = __toModule2(require_react_is());
    import_react22 = __toModule2(require_react2());
    import_shallowequal = __toModule2(require_shallowequal());
    init_stylis_browser_esm();
    init_unitless_browser_esm();
    import_is_prop_valid = __toModule2(require_emotion_is_prop_valid_cjs());
    import_hoist_non_react_statics = __toModule2(require_hoist_non_react_statics_cjs());
    g = function(e2, t2) {
    ...
    ie = /^\s*\/\/.*$/gm;
    ae = [":", "[", ".", "#"];
    ue = import_react22.default.createContext();
    le = ue.Consumer;
    de = import_react22.default.createContext();
    ...
    Ge = import_react22.default.createContext();
    Le = Ge.Consumer;
    Ye = {};
    He = function(e2) {
    ...
    Je = function() {
      function e2() {
        ...
        this._emitSheetCSS = function() {
          ...
          return o2 && (n2.nonce = o2), [import_react22.default.createElement("style", v({}, n2, { key: "sc-0-0" }))];
        }, this.seal = function() {
          e3.sealed = true;
      ...
      return t2.collectStyles = function(e3) {
        return this.sealed ? j(2) : import_react22.default.createElement(ye, { sheet: this.instance }, e3);
      }, t2.interleaveWithNodeStream = function(e3) {
        return j(3);
      }, e2;
    }();
    Xe = function(e2) {
      var t2 = import_react22.default.forwardRef(function(t3, n2) {
        var o2 = (0, import_react22.useContext)(Ge), i3 = e2.defaultProps, a2 = Re(t3, o2, i3);
        return false, import_react22.default.createElement(e2, v({}, t3, { theme: a2, ref: n2 }));
      });
      return (0, import_hoist_non_react_statics.default)(t2, e2), t2.displayName = "WithTheme(" + _(e2) + ")", t2;
    };
    Ze = function() {
      return (0, import_react22.useContext)(Ge);
    };
    Ke = { StyleSheet: Z, masterSheet: he };
    styled_components_browser_esm_default = He;
  }
});
var require_react_dom_production_min = __commonJS2({
  "../../node_modules/react-dom/cjs/react-dom.production.min.js"(exports2) {
    "use strict";
    var aa = require_react2();
    ...
    function qa(a2, b2, c2, d2) {
      var e2 = D2.hasOwnProperty(b2) ? D2[b2] : null;
    ...
    function Ih() {
      if (S2 === null) {
        ...
        a2 = S2.next;
      var b2 = T2 === null ? R2.memoizedState : T2.next;
      if (b2 !== null)
        T2 = b2, S2 = a2;
      else {
        if (a2 === null)
    ...
    function Nh(a2, b2, c2, d2) {
      ...
      He2(C2, c2) && He2(x2, b2) && He2(A2, d2) || (a2 = { pending: null, dispatch: null, lastRenderedReducer: Jh, lastRenderedState: n2 }, a2.dispatch = l2 = Oh.bind(null, R2, a2), k2.queue = a2, k2.baseQueue = null, n2 = Mh(e2, b2, c2), k2.memoizedState = k2.baseState = n2);
      return n2;
    }
    ...
    function Rh(a2, b2, c2, d2) {
      a2 = { tag: a2, create: b2, destroy: c2, deps: d2, next: null };
      b2 = R2.updateQueue;
      b2 === null ? (b2 = { lastEffect: null }, R2.updateQueue = b2, b2.lastEffect = a2.next = a2) : (c2 = b2.lastEffect, c2 === null ? b2.lastEffect = a2.next = a2 : (d2 = c2.next, c2.next = a2, a2.next = d2, b2.lastEffect = a2));
      return a2;
    }
    function Sh(a2) {
      var b2 = Hh();
    ...
    function Jg(a2, b2, c2) {
      ...
      var d2 = eg();
      b2 === 1 ? (X2 & 8) !== 0 && (X2 & 48) === 0 ? Lj(a2) : (Mj(a2, c2), X2 === 0 && (wj(), ig())) : ((X2 & 4) === 0 || d2 !== 98 && d2 !== 99 || (Cj === null ? Cj = /* @__PURE__ */ new Set([a2]) : Cj.add(a2)), Mj(a2, c2));
      vj = a2;
    }
    function Kj(a2, b2) {
      a2.lanes |= b2;
            ...
            if (k2 !== null && typeof k2 === "object" && typeof k2.then === "function") {
              ...
              do {
                ...
                if (C2) {
                  ...
                  h2 = b2;
                  var q2 = f.pingCache;
                  q2 === null ? (q2 = f.pingCache = new Oi(), k2 = /* @__PURE__ */ new Set(), q2.set(l2, k2)) : (k2 = q2.get(l2), k2 === void 0 && (k2 = /* @__PURE__ */ new Set(), q2.set(l2, k2)));
                  if (!k2.has(h2)) {
                    k2.add(h2);
...
var require_styled_components = __commonJS2({
  "../../node_modules/react-shadow/styled-components.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var e2 = require_react2();
...
var import_react20 = __toModule2(require_react2());
var import_react21 = __toModule2(require_react2());
var React4 = __toModule2(require_react2());
var import_zustand = __toModule2(require_zustand());
var import_shallow = __toModule2(require_shallow());
var import_react_reconciler = __toModule2(require_react_reconciler());
var import_scheduler = __toModule2(require_scheduler());
...
var react_merge_refs_esm_default2 = mergeRefs2;
var import_react7 = __toModule2(require_react2());
var import_debounce = __toModule2(require_debounce());
function useMeasure({
  debounce: debounce$1,
  scroll,
  polyfill
  ...
  const [bounds, set] = (0, import_react7.useState)({
    left: 0,
    top: 0,
    width: 0,
    height: 0,
  ...
  const state = (0, import_react7.useRef)({
    element: null,
  ...
  const [forceRefresh, resizeChange, scrollChange] = (0, import_react7.useMemo)(() => {
    const callback = () => {
  ...
  (0, import_react7.useEffect)(() => removeListeners, []);
  ...
  function intersect(filter) {
    ...
    for (const intersect2 of intersects) {
      ...
      while (eventObject) {
        ...
        if (handlers)
          intersections.push(__spreadProps2(__spreadValues2({}, intersect2), {
            eventObject
          }));
      ...
      for (const hit of intersections) {
        ...
        const setPointerCapture = (id) => {
          if (internal.capturedMap.has(id)) {
            ...
            internal.capturedMap.set(id, /* @__PURE__ */ new Map([[hit.eventObject, hit]]));
          }
        ...
        let raycastEvent = __spreadProps2(__spreadValues2(__spreadValues2({}, hit), extractEventProps), {
          spaceX: mouse.x,
          spaceY: mouse.y,
          intersections,
  ...
  function cancelPointer(hits) {
    ...
    Array.from(internal.hovered.values()).forEach((hoveredObj) => {
      if (!hits.length || !hits.find((hit) => hit.object === hoveredObj.object && hit.index === hoveredObj.index)) {
        ...
        if (handlers) {
          const data = __spreadProps2(__spreadValues2({}, hoveredObj), {
            intersections: hits || []
          });
...
function prepare(object, state) {
  ...
  if (state != null && state.instance || !instance.__r3f) {
    instance.__r3f = __spreadValues2({
      root: null,
      memoizedProps: {},
      objects: []
    }, state);
...
function createRenderer(roots2) {
  function applyProps2(instance, newProps, oldProps = {}, accumulative = false) {
    ...
    const filteredProps = __spreadValues2({}, newProps);
    ...
    if (filteredPropsEntries.length > 0) {
      ...
      if (handlers.length) {
        ...
        localState.handlers = handlers.reduce((acc, key) => __spreadProps2(__spreadValues2({}, acc), {
          [key]: newProps[key]
        }), {});
      }
      if (instance.parent)
  ...
  const reconciler2 = (0, import_react_reconciler.default)({
    ...
    commitUpdate(instance, updatePayload, type, oldProps, newProps, fiber) {
      if (instance.__r3f.instance && newProps.object && newProps.object !== instance) {
        ...
        const _a = newProps, {
          args: argsNew = []
        } = _a, restNew = __objRest2(_a, [
          "args"
        ]);
        const _b = oldProps, {
          args: argsOld = []
        } = _b, restOld = __objRest2(_b, [
          "args"
        ]);
...
var createStore = (applyProps2, invalidate2, advance2, props) => {
  ...
  const rootState = (0, import_zustand.default)((set, get2) => {
    ...
    const _a = raycastOptions || {}, {
      params
    } = _a, options = __objRest2(_a, [
      "params"
    ]);
    applyProps2(raycaster, __spreadProps2(__spreadValues2({
      enabled: true
    }, options), {
      params: __spreadValues2(__spreadValues2({}, raycaster.params), params)
    }), {});
    ...
    const setPerformanceCurrent = (current) => set((state2) => ({
      performance: __spreadProps2(__spreadValues2({}, state2.performance), {
        current
      })
    }));
    return {
      ...
      frameloop,
      onPointerMissed,
      performance: __spreadProps2(__spreadValues2({
        current: 1,
        min: 0.5,
        max: 1,
        debounce: 200
      ...
      setSize: (width, height) => {
        ...
        set((state2) => ({
          size: size2,
          viewport: __spreadValues2(__spreadValues2({}, state2.viewport), getCurrentViewport(camera, defaultTarget, size2))
        }));
      },
      setDpr: (dpr2) => set((state2) => ({
        viewport: __spreadProps2(__spreadValues2({}, state2.viewport), {
          dpr: setDpr(dpr2)
        })
      })),
      events: {
      ...
      internal: {
        ...
        subscribe: (ref, priority = 0) => {
          set(({
            ...
            internal: __spreadProps2(__spreadValues2({}, internal), {
...
function createPointerEvents(store) {
  ...
  return {
    connected: false,
    handlers: Object.keys(names).reduce((acc, key) => __spreadProps2(__spreadValues2({}, acc), {
    ...
    connect: (target) => {
      ...
      set((state) => ({
        events: __spreadProps2(__spreadValues2({}, state.events), {
          connected: target
        })
      }));
...
var Canvas = React4.forwardRef(function Canvas2(_a, forwardedRef) {
  var _b = _a, {
    children,
    fallback,
    tabIndex,
  ...
  const [containerRef, size] = web_default(__spreadValues2({
    scroll: true,
    debounce: {
      scroll: 50,
      resize: 0
  ...
  useIsomorphicLayoutEffect(() => {
    if (size.width > 0 && size.height > 0) {
      render(React4.createElement(ErrorBoundary, {
        set: setError
      }, React4.createElement(React4.Suspense, {
        fallback: React4.createElement(Block, {
          set: setBlock
        })
      }, children)), canvasRef.current, __spreadProps2(__spreadValues2({}, props), {
        size,
  ...
  return React4.createElement("div", {
    ...
    ref: react_merge_refs_esm_default2([canvasRef, forwardedRef]),
    style: {
      display: "block"
    }
  }, fallback));
});
function useThree2(selector = (state) => state, equalityFn) {
  const useStore = React4.useContext(context);
  if (!useStore)
    throw `R3F hooks can only be used within the Canvas component!`;
  return useStore(selector, equalityFn);
}
function useFrame2(callback, renderPriority = 0) {
  const {
    subscribe
  } = React4.useContext(context).getState().internal;
  const ref = React4.useRef(callback);
  React4.useLayoutEffect(() => void (ref.current = callback), [callback]);
...
var createRendererInstance = (gl, canvas) => isRenderer(gl) ? gl : new WebGLRenderer(__spreadValues2({
...
function render(element, canvas, _a = {}) {
  ...
  if (!fiber) {
    ...
    store = createStore(applyProps, invalidate, advance, __spreadValues2({
      gl: glRenderer,
      size
    }, props));
  ...
  if (store && fiber) {
    reconciler.updateContainer(React4.createElement(Provider, {
      store,
      element,
      onCreated,
      target: canvas
...
function Provider({
  ...
  React4.useEffect(() => {
    const state = store.getState();
    state.set((state2) => ({
      internal: __spreadProps2(__spreadValues2({}, state2.internal), {
        active: true
      })
    }));
...
var import_shallow5 = __toModule2(require_shallow());
var import_styled_components2 = __toModule2(require_styled_components());
var import_react12 = __toModule2(require_react2());
var import_react9 = __toModule2(require_react2());
function _extends() {
...
var React22 = __toModule2(require_react2());
var ReactDOM = __toModule2(require_react_dom());
var v1 = new Vector3();
var v2 = new Vector3();
var v3 = new Vector3();
...
var Html = React22.forwardRef((_a, ref) => {
  var _b = _a, {
    children,
    eps = 1e-3,
    style,
  ...
  const size = useThree2(({
    size: size2
  }) => size2);
  const raycaster = useThree2(({
    raycaster: raycaster2
  }) => raycaster2);
  const [el] = React22.useState(() => document.createElement(as));
  const group = React22.useRef(null);
  const oldZoom = React22.useRef(0);
  const oldPosition = React22.useRef([0, 0]);
  const transformOuterRef = React22.useRef(null);
  const transformInnerRef = React22.useRef(null);
  ...
  const transformInnerStyles = React22.useMemo(() => ({
    position: "absolute",
    pointerEvents: "auto"
  }), []);
  React22.useLayoutEffect(() => {
    if (transform) {
      ReactDOM.render(React22.createElement("div", {
  ...
  const visible = React22.useRef(true);
  useFrame2(() => {
    if (group.current) {
      camera.updateMatrixWorld();
  ...
  return React22.createElement("group", _extends({}, props, {
    ref: group
  }));
});
var React32 = __toModule2(require_react2());
function create2(type) {
  const El = type + "BufferGeometry";
  return React32.forwardRef((_a, ref) => {
    var _b = _a, {
      args,
      children
    } = _b, props = __objRest2(_b, [
    ...
    return React32.createElement("mesh", _extends({
      ref
    }, props), React32.createElement(El, {
      attach: "geometry",
      args
    }), children);
  });
...
var React42 = __toModule2(require_react2());
var PerspectiveCamera22 = React42.forwardRef((_a, ref) => {
  var _b = _a, {
    makeDefault,
    manual
  } = _b, props = __objRest2(_b, [
  ...
  const cameraRef = React42.useRef();
  ...
  return React42.createElement("perspectiveCamera", _extends({
    ref: react_merge_refs_esm_default2([cameraRef, ref])
  }, props));
});
var import_shallow2 = __toModule2(require_shallow());
var import_react32 = __toModule2(require_react2());
function useSelected() {
  const [state, set] = (0, import_react32.useState)(void 0);
  const stateRef = (0, import_react32.useRef)(state);
  stateRef.current = state;
  (0, import_react32.useLayoutEffect)(() => {
    ...
    setFromStudio(import_studio2.default.selection);
    return import_studio2.default.onSelectionChange(setFromStudio);
  }, []);
  return state;
}
...
var import_queue_microtask = __toModule2(require_queue_microtask());
var import_react42 = __toModule2(require_react2());
var import_react_dom = __toModule2(require_react_dom());
var TRACE = false;
function useForceUpdate(debugLabel) {
  const [, setTick] = (0, import_react42.useState)(0);
...
function usePrism(fn, deps, debugLabel) {
  const fnAsCallback = (0, import_react42.useCallback)(fn, deps);
  const boxRef = (0, import_react42.useRef)(null);
  if (!boxRef.current) {
    boxRef.current = new import_dataverse.Box(fnAsCallback);
  } else {
    boxRef.current.set(fnAsCallback);
  }
  const derivation = (0, import_react42.useMemo)(() => (0, import_dataverse2.prism)(() => {
...
function useDerivation(der, debugLabel) {
  ...
  const ref = (0, import_react42.useRef)(void 0);
  if (!ref.current) {
    lastOrder++;
    ref.current = {
      order: lastOrder,
...
var editorSheetObjectConfig = {
  viewport: import_core4.types.compound({
    showAxes: import_core4.types.boolean(true, { label: "Axes" }),
    showGrid: import_core4.types.boolean(true, { label: "Grid" }),
    showOverlayIcons: import_core4.types.boolean(false, { label: "Overlay Icons" }),
    shading: import_core4.types.stringLiteral("rendered", {
      flat: "Flat",
      rendered: "Rendered",
      solid: "Solid",
      wireframe: "Wireframe"
    }, { as: "menu", label: "Shading" }),
    referenceWindow: import_core4.types.stringLiteral("minimized", {
      maximized: "Maximized",
      minimized: "Minimized",
      hidden: "Hidden"
    }, { as: "menu", label: "Reference Window" }),
    lighting: import_core4.types.stringLiteral("physical", {
      physical: "Physical",
      legacy: "Legacy"
    }, { as: "menu", label: "Lighting" })
  }, { label: "Viewport Config" }),
  transformControls: import_core4.types.compound({
    mode: import_core4.types.stringLiteral("translate", {
      translate: "Translate",
      rotate: "Rotate",
      scale: "Scale"
    }, { as: "switch", label: "Mode" }),
    space: import_core4.types.stringLiteral("world", {
      local: "Local",
      world: "World"
...
function getEditorSheet() {
  if (!sheet) {
    sheet = import_studio3.default.getStudioProject().sheet("R3F UI");
  }
  return sheet;
}
...
var import_react62 = __toModule2(require_react2());
var import_react52 = __toModule2(require_react2());
var DefaultContext = {
  color: void 0,
  size: void 0,
  className: void 0,
...
function Tree2Element(tree) {
  return tree && tree.map(function(node, i3) {
    return import_react62.default.createElement(node.tag, __assign({
      key: i3
...
function GenIcon(data) {
  return function(props) {
    return import_react62.default.createElement(IconBase, __assign({
...
function IconBase(props) {
  var elem = function(conf) {
    ...
    return import_react62.default.createElement("svg", __assign({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    ...
    }), title && import_react62.default.createElement("title", null, title), props.children);
  };
  return IconContext !== void 0 ? import_react62.default.createElement(IconContext.Consumer, null, function(conf) {
    return elem(conf);
  }) : elem(DefaultContext);
}
...
var import_react72 = __toModule2(require_react2());
var icons = {
  collection: import_react72.default.createElement(BsFillCollectionFill, null),
  cube: import_react72.default.createElement(GiCube, null),
  lightBulb: import_react72.default.createElement(GiLightBulb, null),
  spotLight: import_react72.default.createElement(GiLightProjector, null),
  sun: import_react72.default.createElement(BiSun, null),
  camera: import_react72.default.createElement(BsCameraVideoFill, null),
  cloud: import_react72.default.createElement(BsCloudFill, null)
};
var icons_default = icons;
var import_react8 = __toModule2(require_react2());
...
var DragDetectorProvider = ({
  ...
  return import_react8.default.createElement(dragDetectorContext.Provider, {
    value: dragging
  }, children);
};
var useDragDetector = () => (0, import_react8.useContext)(dragDetectorContext);
var import_zustand2 = __toModule2(require_zustand());
...
var EditableProxy = ({ storeKey, object }) => {
  ...
  const editable2 = editables[storeKey];
  ...
  (0, import_react9.useLayoutEffect)(() => {
    ...
    if (editable2 == null ? void 0 : editable2.visibleOnlyInEditor) {
      object.visible = true;
    }
    return () => {
      object.visible = originalVisibility;
    };
  }, [editable2 == null ? void 0 : editable2.visibleOnlyInEditor, object.visible]);
  const [hovered, setHovered] = (0, import_react9.useState)(false);
  const scene = useThree2((state) => state.scene);
  const helper = (0, import_react9.useMemo)(() => {
    var _a2, _b;
    return (_b = editable2 == null ? void 0 : (_a2 = editable2.objectConfig).createHelper) == null ? void 0 : _b.call(_a2, object);
  }, [object]);
  (0, import_react9.useEffect)(() => {
    if (helper == void 0) {
      return;
  ...
  (0, import_react9.useEffect)(() => {
    if (!editable2)
      return;
    const sheetObject2 = editable2.sheetObject;
    const objectConfig = editable2.objectConfig;
    const setFromTheatre = (newValues) => {
      var _a2;
  ...
  if (!editable2)
    return null;
  return import_react9.default.createElement(import_react9.default.Fragment, null, import_react9.default.createElement("group", {
    onClick: (e2) => {
      if (e2.delta < 2) {
        e2.stopPropagation();
        ...
        if (!theatreObject) {
          ...
          import_studio.default.setSelection([theatreObject]);
        }
      }
    },
  ...
  }, import_react9.default.createElement("primitive", {
    object
  }, (showOverlayIcons || editable2.objectConfig.dimensionless && selected !== storeKey) && import_react9.default.createElement(Html, {
    center: true,
    style: {
      pointerEvents: "none",
      transform: "scale(2)",
  ...
  }, import_react9.default.createElement("div", null, icons_default[editable2.objectConfig.icon])), editable2.objectConfig.dimensionless && import_react9.default.createElement(Sphere, {
    args: [2, 4, 2],
    onClick: (e2) => {
      if (e2.delta < 2) {
        e2.stopPropagation();
  ...
  }, import_react9.default.createElement("meshBasicMaterial", {
    visible: false
  })))));
};
var EditableProxy_default = EditableProxy;
var import_react11 = __toModule2(require_react2());
var TransformControls2 = (0, import_react11.forwardRef)((_a, ref) => {
  ...
  const { camera, gl, invalidate: invalidate2 } = useThree2();
  ...
  return import_react11.default.createElement("primitive", __spreadValues2({
    dispose: null,
    object: controls,
    ref
  }, props));
...
var import_shallow3 = __toModule2(require_shallow());
var ProxyManager = ({ orbitControlsRef }) => {
      ...
      if (object.userData.__editable) {
        ...
        if (editableProxies2[theatreKey] || !editables[theatreKey]) {
          ...
          editableProxies2[theatreKey] = {
            portal: createPortal(import_react12.default.createElement(EditableProxy_default, {
              storeKey: theatreKey,
              object
            }), object.parent),
            object,
  ...
  const editable2 = selected ? editables[selected] : void 0;
  ...
  return import_react12.default.createElement(import_react12.default.Fragment, null, import_react12.default.createElement("primitive", {
    object: sceneProxy
  }), selected && editableProxyOfSelected && editable2 && editable2.objectConfig.useTransformControls && import_react12.default.createElement(TransformControls_default, {
    ...
    onObjectChange: () => {
      ...
      scrub.current.capture(({ set }) => {
        if (transformControlsMode === "translate") {
          set(sheetObject2.props.position, __spreadProps2(__spreadValues2({}, sheetObject2.value.position), {
            x: obj.position.x,
            y: obj.position.y,
            z: obj.position.z
          }));
        ...
        if (transformControlsMode === "rotate") {
          set(sheetObject2.props.rotation, __spreadProps2(__spreadValues2({}, sheetObject2.value.rotation), {
            x: obj.rotation.x,
            y: obj.rotation.y,
            z: obj.rotation.z
          }));
...
var React12 = __toModule2(require_react2());
var import_react14 = __toModule2(require_react2());
...
var OrbitControls = (0, import_react14.forwardRef)((_a, ref) => {
  ...
  const invalidate2 = useThree2(({ invalidate: invalidate3 }) => invalidate3);
  const defaultCamera = useThree2(({ camera: camera2 }) => camera2);
  const gl = useThree2(({ gl: gl2 }) => gl2);
  const events = useThree2(({ events: events2 }) => events2);
  const set = useThree2(({ set: set2 }) => set2);
  const get2 = useThree2(({ get: get3 }) => get3);
  const performance2 = useThree2(({ performance: performance3 }) => performance3);
  ...
  return React12.createElement("primitive", __spreadValues2({
    ref,
    object: controls,
    enableDamping
  }, restProps));
});
var import_react16 = __toModule2(require_react2());
var import_react17 = __toModule2(require_react2());
var import_react15 = __toModule2(require_react2());
...
var camConf = {
  transform: {
    position: {
      x: import_core5.types.number(10),
      y: import_core5.types.number(10),
      z: import_core5.types.number(0)
    },
    target: {
      x: import_core5.types.number(0),
      y: import_core5.types.number(0),
      z: import_core5.types.number(0)
    }
  },
  lens: {
    zoom: import_core5.types.number(1, { range: [1e-4, 10] }),
    fov: import_core5.types.number(50, { range: [1, 1e3] }),
    near: import_core5.types.number(0.1, { range: [0, Infinity] }),
    far: import_core5.types.number(2e3, { range: [0, Infinity] }),
    focus: import_core5.types.number(10, { range: [0, Infinity] }),
    filmGauge: import_core5.types.number(35, { range: [0, Infinity] }),
    filmOffset: import_core5.types.number(0, { range: [0, Infinity] })
  }
};
function useSnapshotEditorCamera(snapshotEditorSheet, paneId) {
  ...
  const node = import_react17.default.createElement(import_react17.default.Fragment, null, import_react17.default.createElement(PerspectiveCamera22, {
    makeDefault: true,
    ref: camRef,
    position: [0, 102, 0]
  }), import_react17.default.createElement(OrbitControls, {
    makeDefault: true,
...
var import_react18 = __toModule2(require_react2());
var import_react19 = __toModule2(require_react2());
var import_shallow4 = __toModule2(require_shallow());
init_styled_components_browser_esm();
...
var ReferenceWindow = ({
  ...
  (0, import_react19.useEffect)(() => {
    ...
    const draw = (gl2) => () => {
      ...
      ctx2.drawImage(gl2.domElement, 0, 0, width, height);
    };
    if (gl) {
      draw(gl)();
    }
  ...
  return import_react19.default.createElement(Container, {
    ...
    width,
    height
  }) : import_react19.default.createElement(Static, null, import_react19.default.createElement(Warning, null, import_react19.default.createElement(TiWarningOutline, {
    size: "3em"
  }), import_react19.default.createElement("code", null, "Please set ", import_react19.default.createElement("pre", null, `gl={{ preserveDrawingBuffer: true }}`), " on the r3f Canvas for the reference window to work."))));
};
...
var EditorScene = ({
  ...
  var _a, _b, _c;
  const [gl, scene, camera] = useThree2((store) => [store.gl, store.scene, store.camera], import_shallow5.default);
  ...
  return import_react21.default.createElement(DragDetectorProvider, null, showGrid && import_react21.default.createElement("primitive", {
    object: grid
  }), showAxes && import_react21.default.createElement("axesHelper", {
    args: [500]
  }), editorCamera, import_react21.default.createElement("primitive", {
    object: helpersRoot
  }), import_react21.default.createElement(ProxyManager_default, {
    orbitControlsRef
  }), import_react21.default.createElement("color", {
    attach: "background",
    args: [0.24, 0.24, 0.24]
  }));
};
...
var SnapshotEditor = (props) => {
  ...
  const onPointerMissed = (0, import_react20.useCallback)(() => {
    const obj = import_studio5.default.selection.find((sheetOrObject) => allRegisteredObjects.has(sheetOrObject));
    if (obj) {
      import_studio5.default.setSelection([obj.sheet]);
    }
  }, []);
  ...
  return import_react21.default.createElement(import_styled_components2.default.div, {
    style: { overflow: "hidden" }
  }, import_react21.default.createElement(ye, {
    disableVendorPrefixes: true
  }, import_react21.default.createElement(import_react21.default.Fragment, null, import_react21.default.createElement(GlobalStyle, null), import_react21.default.createElement(Wrapper, null, import_react21.default.createElement(Overlay, null, import_react21.default.createElement(Tools, {
    ref: setToolsContainer
  }), referenceWindowVisibility !== "hidden" && import_react21.default.createElement(ReferenceWindowContainer, null, import_react21.default.createElement(ReferenceWindow_default, {
  ...
  })), !sceneSnapshot && import_react21.default.createElement(WaitForSceneInitMessage, null, "The scene hasn't been initialized yet. It will appear in the editor as soon as it is.")), import_react21.default.createElement(CanvasWrapper, {
    ref
  }, import_react21.default.createElement(Canvas, {
    onCreated: ({ gl }) => {
    ...
    frameloop: "demand",
    onPointerMissed
  }, import_react21.default.createElement(EditorScene, {
    snapshotEditorSheet,
    paneId
  })))))));
};
var SnapshotEditor_default = SnapshotEditor;
var import_react_dom2 = __toModule2(require_react_dom());
var import_react23 = __toModule2(require_react2());
